...
function mountRulesModal() {
    document.body.insertAdjacentHTML('beforeend', `
        <div id="nounModal" class="modal-backdrop hidden" role="dialog" aria-modal="true" aria-labelledby="nounModalTitle">
            <div class="modal-panel">
                <div class="modal-header">
                    <h3 id="nounModalTitle" class="text-2xl font-black text-slate-900 dark:text-white flex items-center gap-3">Plural Rules</h3>
                    <button type="button" data-modal-close data-modal-initial-focus class="modal-close" aria-label="Close noun rules">✕</button>
                </div>
                <div class="p-6 overflow-y-auto space-y-4 text-sm text-slate-700 dark:text-slate-300">
